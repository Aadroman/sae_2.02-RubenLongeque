...
. Installez Joular pout Java, CodeCarbon pour Python
. Lancez Invite de commande pour Joular ou IDE capable d'interpréter du Python pour CodeCarbon
. Lancez Replit pour C

=== Références

- link:https://gitlab.com/joular/joularjx[Joular]
- link:https://github.com/mlco2/codecarbon[CodeCarbon]
